...
#     return render(request,"Bill_user.html", {})
def Bill_view(request):
...
def day_food(request):
    ...
    #print(c)
    if c==1:          
        return HttpResponse("already added to the menu")
    else:
        v=dayfood1(name=name,date=o,price=price,plate=plate)
        v.save()
        return HttpResponse("successfully added to the menu list")
...
def Day_food_view(request):
    ...
    y1= datetime.strptime('18:00:00',"%H:%M:%S")
